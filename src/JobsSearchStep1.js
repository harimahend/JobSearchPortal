...
const JobsSearchStep1 = (props) => {
  ...
  return (
    <div className="   mt-8 mr-8 mb-8 ml-8 w-[577px] h-[564px]">
      ...
      <label
        className="text-left  font-[#212121] block mb-2"
        htmlFor="location"
      >
        Create a job
      </label>
      ...
      <div className="float-right text-secondary font-medium">
        <button
          class="text-secondary  bg-[#1597E4] hover:bg-[#1597E4] text-white font-bold py-2 px-4 roundedfloat-right text-secondary font-medium"
...
export default JobsSearchStep1;
