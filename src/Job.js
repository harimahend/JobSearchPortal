...
return(
    ...
    <div className="flex flex-wrap -mx-4">
       ...
       <input
        ...
        id="job-title"
        type="text"
        placeholder="Minimum"  value={Experiencemin} onChange={handleExperienceminChange}
      ...
      <div className="mb-4">
          ...
          <input
            ...
            id="company-name"
            type="text"
            placeholder="Minimum"  value={Salarymin} onChange={handleSalaryminChange}
          />
          </div>
      ...
      <div className=" w-full md:w-1/2 px-4 mb-4">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            id="industry"
            type="text"
            placeholder="ex. 100"  value={TotalEmployee} onChange={handleTotalEmployeeChange}
...
<div class="flex items-center mb-4">
    ...
    <label for="default-radio-1" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Quick apply</label>
</div>
</div>
<div className=" w-full md:w-1/2 px-4 mb-4">
<div class="flex items-center">
    <input checked id="default-radio-2" type="radio" value="" name="default-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
    <label for="default-radio-2" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">External apply</label>
</div>
